...
const Report = () => {
  ...
  const [choosedTab, setChoosedTab] = useState('6');

  const onChange = (key: string) => {
    if (key === '2') router.push('reports/users');
    setChoosedTab(key);
  };
  ...
  return (
    <MoreLayout>
      <div className={`border rounded px-4 bg-input py-4 mb-3 flex justify-between items-center`}>
